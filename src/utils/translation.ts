...
export const translations = {
  en: {
    ...
    manageCropCycles: 'Manage Crops',
    irrigationType: 'Irrigation Type',
    irrigationType_Drip: 'Drip',
    irrigationType_Sprinkler: 'Sprinkler',
    irrigationType_Flow: 'Flow',
    irrigationType_Rainfed: 'Rainfed',
    irrigationType_Other: 'Other',
    harvestRevenue: 'Harvest Revenue (₹)',
    harvestYield: 'Harvest Yield / Quantity',
    cropProfit: 'Crop Profit (₹)',
    duplicateCrop: 'Duplicate Crop',
    cropDeleteSuccess: 'Crop cycle deleted successfully',
    cropDeleteErrorHasRecords: 'Cannot delete crop. There are associated records.',
    assignWorker: 'Assign Worker',
    unassignWorker: 'Unassign Worker',
    workerAssignments: 'Worker Assignments',
    searchAssignedWorkers: 'Search assigned workers...',
    assignExistingWorker: 'Assign Existing Worker',
    unassignedWorkers: 'Unassigned Workers',
    receiptTitle: 'Payment Receipt',
    receiptNumber: 'Receipt No.',
    receiptDate: 'Date',
    receiptFarmer: 'Farmer / Owner',
    receiptWorker: 'Worker Name',
    receiptAmount: 'Amount Paid',
    receiptNote: 'Note / Description',
    receiptPaidBy: 'Paid via AgriBook',
    printReceipt: 'Print / Download Receipt',
  },
  te: {
    // Navigation
    home: 'హోమ్',
    ...
    manageCropCycles: 'పంటల నిర్వహణ',
    irrigationType: 'నీటి పారుదల పద్ధతి',
    irrigationType_Drip: 'బిందు సేద్యం (Drip)',
    irrigationType_Sprinkler: 'చిలకరింపు సేద్యం (Sprinkler)',
    irrigationType_Flow: 'కాలువ పారుదల (Flow)',
    irrigationType_Rainfed: 'వర్షాధారం (Rainfed)',
    irrigationType_Other: 'ఇతర పద్ధతి (Other)',
    harvestRevenue: 'కోత ఆదాయం (₹)',
    harvestYield: 'దిగుబడి పరిమాణం',
    cropProfit: 'పంట లాభం (₹)',
    duplicateCrop: 'పంటను నకలు చేయి',
    cropDeleteSuccess: 'పంట విజయవంతంగా తొలగించబడింది',
    cropDeleteErrorHasRecords: 'పంటను తొలగించలేము. ఈ పంటకు హాజరు, కూలి లేదా ఖర్చుల రికార్డులు ఉన్నాయి.',
    assignWorker: 'పనివారిని పంటకు జోడించు',
    unassignWorker: 'పనివారిని పంట నుండి తొలగించు',
    workerAssignments: 'పనివారల కేటాయింపు',
    searchAssignedWorkers: 'కేటాయించిన పనివారల కోసం వెతకండి...',
    assignExistingWorker: 'ఉన్న పనివారిని జోడించు',
    unassignedWorkers: 'పంటకు కేటాయించని పనివారు',
    receiptTitle: 'చెల్లింపు రసీదు',
    receiptNumber: 'రసీదు సంఖ్య',
    receiptDate: 'తేదీ',
    receiptFarmer: 'రైతు / యజమాని',
    receiptWorker: 'పనివారి పేరు',
    receiptAmount: 'చెల్లించిన సొమ్ము',
    receiptNote: 'గమనిక / వివరణ',
    receiptPaidBy: 'అగ్రిబుక్ ద్వారా చెల్లించబడింది',
    printReceipt: 'ప్రింట్ / డౌన్‌లోడ్ రసీదు',
  }
};
