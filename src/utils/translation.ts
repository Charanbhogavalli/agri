...
export const translations = {
  en: {
    ...
    importWorkers: 'Import Existing Workers',
    copyAttendance: 'Copy Attendance',
    copyPayments: 'Copy Payments',
  ...
  te: {
    ...
    importWorkers: 'పాత పనివారిని జోడించు',
    copyAttendance: 'హాజరును కాపీ చేయి',
    copyPayments: 'చెల్లింపులను కాపీ చేయి',
    copyExpenses: 'ఖర్చులను కాపీ చేయి',
